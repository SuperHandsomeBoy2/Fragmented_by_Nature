...
if __name__ == '__main__':
    ...
    '''
    geo_barrier_path = 'Data/global_data/global_barriers_10km.shp'
    road_net_path = 'Data/global_data/global_road_net.shp'     # please replace the name of road net to your road net
    save_path = 'result/global_detour_with_road_map'
